<?php $__env->startSection('titulo', 'Gestion de trabajadores de '. $empresa->nombre); ?>
   ...
   <div class="modal modal fade in" id="newTrabajador" tabindex="-1" role="dialog" data-backdrop="static">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
			  	<?php echo $__env->make('empresa.trabajador._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          </div>
      </div>
   </div>
         ...
         <div class="box-tools pull-right">
			 <div class="dropdown">
				 ...
				 <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					 ...
					 <li><a href="<?php echo e(route('empresa.trabajadores.import.index', ['id' => $empresa->id, 'name' => $empresa->nombre])); ?>">Importa cvs</a></li>
				 </ul>
			 </div>
         </div>
       </div>
...
<?php $__env->startPush('script'); ?>
   ...
   "lengthMenu": [ [15, 25, 50, -1], [15, 25, 50, "Todos"] ],
				...
				'pdfHtml5'
								...
								processing: true,
								serverSide: true,
								ajax: '/api/trabajadores/<?php echo e($empresa->id); ?>/get',
								columns: [
