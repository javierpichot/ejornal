			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="#" class="btn btn-warning btn-primary" onclick="event.preventDefault(); document.getElementById('<?php echo e($formIdImpersonate); ?>').submit();">
						...
						<a data-id="<?php echo e($s->id); ?>" data-href="<?php echo e(route('admin.user.destroy', ['id' => $s->id])); ?>" class="delete-confirm btn btn-danger" href="#">
							<?php echo e(csrf_field()); ?>
