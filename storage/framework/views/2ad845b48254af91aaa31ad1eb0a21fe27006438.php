    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" aria-current="page"><a
                        href="<?php echo e(route('empresa.show', ['id' => $empresa->id, 'name' => $empresa->nombre] )); ?>">Dashboard
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo e(route('trabajador.incidencia.show', ['id' => $trabajador->id, 'name' => $trabajador->nombre, 'empresa_id' => $empresa->id])); ?>"
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo e(route('trabajador.consulta.show', ['id' => $trabajador->id, 'name' => $trabajador->nombre, 'empresa_id' => $empresa->id])); ?>"
                           class="small-box-footer">
                            Más info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo e(route('trabajador.documentacion.show', ['id' => $trabajador->id, 'name' => $trabajador->nombre, 'empresa_id' => $empresa->id])); ?>"
                           class="small-box-footer">
                            Más info <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
