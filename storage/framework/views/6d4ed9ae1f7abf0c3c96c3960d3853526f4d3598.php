    ...
    <div class="modal fade" id="newticket" tabindex="-1" role="dialog" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <?php echo $__env->make('tickets_jornals.includes.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.dashboard.index')); ?>">Equipo de Jornal</a></li>
		<li class="breadcrumb-item active" aria-current="page">Tickets interno</li>
	</ol>
</nav>
                    ...
                    <table class="table table-striped table-bordered" id="empresa-ticket">
                        ...
                        <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr id="ticket_<?php echo e($c->id); ?>">
                                ...
                                <td>
                                    <?php echo e(isset($c->nombre) ? $c->nombre : ''); ?> <?php echo e(isset($c->apellido) ? $c->apellido : ''); ?>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-warning" title="Edit" href="#modalForm" data-toggle="modal" data-href="<?php echo e(route('ticket-jornals.edit', ['id' => $c->id])); ?>"><i title="Editar ticket" class="fa fa-pencil"></i></a>

                                    <a href="<?php echo e(route('ticket-jornals.comentarios.view', ['id' => $c->id])); ?>" target="_blank"><button class="btn btn-success"><i title="Ver comentarios" class="fa fa-commenting-o"></i></button></a>

                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-danger delete-confirm" data-id="<?php echo e($c->id); ?>" data-href="<?php echo e(route('ticket-jornals.destroy', ['id' => $c->id])); ?>">
