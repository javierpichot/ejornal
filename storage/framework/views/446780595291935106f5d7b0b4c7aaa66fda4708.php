<?php $__env->startSection('titulo', 'Informacion General de'. $profesional->nombre ); ?>

<?php $__env->startSection('main-content'); ?>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('home')); ?>">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Profesional <?php echo e($profesional->nombre); ?> detalles</li>
        </ol>
    </nav>
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
                Informaci&oacute;n General de <?php echo e($profesional->nombre); ?>
                      ...
                      <div class="row">
                          <div class="col-md-12 col-sm-12 <?php echo e($errors->has('profesional_tipo_id') ? ' has-error' : ''); ?>">
                              <div class="form-group">
                                  ...
                                  <?php echo Form::select('profesional_tipo_id', $tipo_profesional->pluck('nombre', 'id'), isset($profesional) ? $profesional->profesional_tipo_id : null, ['placeholder' => 'Seleccione tipo profesional', 'class' => 'form-control box-size', 'disabled' => true]); ?>
                      ...
                      <div class="row">
                          <div class="col-md-12 col-sm-12 <?php echo e($errors->has('user_id') ? ' has-error' : ''); ?>">
                              <div class="form-group">
                                  ...
                                  <?php echo Form::select('user_id', $users->pluck('email', 'id'), isset($profesional) ? $profesional->user_id : null, ['placeholder' => 'Seleccione un usuario web', 'class' => 'form-control box-size', 'id' => 'usuario_id', 'disabled' => true]); ?>
                      ...
                      <div class="row">
                          <div class="col-md-12 col-sm-12 <?php echo e($errors->has('documento') ? ' has-error' : ''); ?>">
                              <div class="form-group">
                                  ...
                                  <?php echo e(Form::text('documento', isset($profesional) ? $profesional->documento : null, ['class' => 'form-control box-size', 'placeholder' => "XXXXX", 'id' => "documento", 'disabled' => true])); ?>
                      ...
                      <div class="row">
                          <div class="col-md-12 col-sm-12 <?php echo e($errors->has('numero_matricula') ? ' has-error' : ''); ?>">
                              <div class="form-group">
                                  ...
                                  <?php echo e(Form::number('numero_matricula', isset($profesional) ? $profesional->numero_matricula : null, ['class' => 'form-control box-size', 'placeholder' => "XXXXXXXX", 'disabled' => true])); ?>
                      ...
                      <div class="row">
                          <div class="col-md-12 col-sm-12 <?php echo e($errors->has('poliza') ? ' has-error' : ''); ?>">
                              <div class="form-group">
                                  ...
                                  <?php echo e(Form::text('poliza', isset($profesional) ? $profesional->poliza : null, ['class' => 'form-control box-size', 'placeholder' => "XXXXXXXX", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('nombre') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('nombre', isset($profesional) ? $profesional->nombre : null, ['class' => 'form-control box-size', 'placeholder' => "Nombre", 'disabled' => true])); ?>
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('apellido') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('apellido', isset($profesional) ? $profesional->apellido : null, ['class' => 'form-control box-size', 'placeholder' => "Apellido", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('celular') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('celular', isset($profesional) ? $profesional->celular : null, ['class' => 'form-control box-size', 'placeholder' => "Nº de celular", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('nombre_familiar') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('nombre_familiar', isset($profesional) ? $profesional->nombre_familiar : null, ['class' => 'form-control box-size', 'placeholder' => "Nombre familiar", 'disabled' => true])); ?>
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('celular_familiar') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('celular_familiar', isset($profesional) ? $profesional->celular_familiar : null, ['class' => 'form-control box-size', 'placeholder' => "Telefono familiar", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('direccion') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('direccion', isset($profesional) ? $profesional->direccion : null, ['class' => 'form-control box-size', 'placeholder' => "Dirección", 'disabled' => true])); ?>
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('localidad_id') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo Form::select('localidad_id', $localidades->pluck('nombre', 'id'), isset($profesional) ? $profesional->localidad_id : null, ['placeholder' => 'Seleccione una localidad', 'class' => 'form-control box-size', 'id' => 'roles', 'disabled' => true
                              ]); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 <?php echo e($errors->has('observacion_direccion') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('observacion_direccion', isset($profesional) ? $profesional->observacion_direccion : null, ['class' => 'form-control box-size', 'placeholder' => "Observaciones de dirección", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('obra_social_id') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo Form::select('obra_social_id', $obra_social->pluck('nombre', 'id'), isset($profesional) ? $profesional->obra_social_id : null, ['placeholder' => 'Seleccione una obra social', 'class' => 'form-control box-size', 'id' => 'roles', 'disabled' => true
                              ]); ?>
                      ...
                      <div class="col-md-6 col-sm-12 <?php echo e($errors->has('numero_obra_social') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('numero_obra_social', isset($profesional) ? $profesional->numero_obra_social : null, ['class' => 'form-control box-size', 'placeholder' => "Nº afiliado obra social", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 <?php echo e($errors->has('observacion_facturacion') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('observacion_facturacion', isset($profesional) ? $profesional->observacion_facturacion : null, ['class' => 'form-control box-size', 'placeholder' => "Observaciones de facturación", 'disabled' => true])); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 <?php echo e($errors->has('observacion_supervision') ? ' has-error' : ''); ?>">
                          <div class="form-group">
                              ...
                              <?php echo e(Form::text('observacion_supervision', isset($profesional) ? $profesional->observacion_supervision : null, ['class' => 'form-control box-size', 'placeholder' => "Observaciones de supervisión", 'disabled' => true])); ?>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#foto_titulo').fileinput({
                <?php if(isset($profesional)) { ?>
                initialPreview: ["<?php echo e(asset('storage/profesionales/'. $profesional->id . '/' . $profesional->foto_titulo)); ?>"],
                initialPreviewAsData: true,
                <?php } ?>
                maxFileCount: 5,
                theme: 'fa',
            ...
            $('#foto_documento').fileinput({
                <?php if(isset($profesional)) { ?>
                initialPreview: ["<?php echo e(asset('storage/profesionales/'. $profesional->id . '/' . $profesional->foto_documento)); ?>"],
                initialPreviewAsData: true,
                <?php } ?>
                maxFileCount: 5,
                theme: 'fa',
            ...
            $('#foto_seguro').fileinput({
                <?php if(isset($profesional)) { ?>
                initialPreview: ["<?php echo e(asset('storage/profesionales/'. $profesional->id . '/' .$profesional->foto_seguro)); ?>"],
                initialPreviewAsData: true,
                <?php } ?>
                maxFileCount: 5,
                theme: 'fa',
            ...
            $('#foto_matricula').fileinput({
                <?php if(isset($profesional)) { ?>
                initialPreview: ["<?php echo e(asset('storage/profesionales/'. $profesional->id . '/' .$profesional->foto_matricula)); ?>"],
                initialPreviewAsData: true,
                <?php } ?>
                maxFileCount: 5,
                theme: 'fa',
