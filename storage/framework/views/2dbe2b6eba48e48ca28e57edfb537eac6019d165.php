<?php if(isset($ticket)): ?>
    <?php echo e(Form::model($ticket, ['route' => ['trabajador.ticket.update', $ticket->id, $ticket->empresa_id], 'role' => 'form', 'method' => 'PATCH', 'id' => 'ticket'])); ?>

    <input type="hidden" name="trabajador_id" value="<?php echo e($ticket->trabajador->id); ?>">
    <input type="hidden" name="empresa_id" value="<?php echo e($ticket->empresa->id); ?>">
<?php else: ?>
    <?php echo Form::open(['route' => 'trabajador.ticket.store', 'id'=>'ticket']); ?>
...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?php echo e(isset($ticket)?'Editar':'Crear nuevo'); ?> ticket</h4>
