...
/**
 * Class EventsJornalController
 * @package App\Http\Controllers
 */
class EventsJornalController extends Controller
{
     ...
     */
    public function __construct(EventsJornal $event)
    {
    ...
    {
        return view('events_jornal.index');
    }
    /**
    ...
    {
        $users = User::has('profesional')->get();
        $profesionals = json_encode($this->_make_users_empresa($users));
        return view('events_jornal.modal_event', compact('profesionals'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return view('events_jornal.view_event', compact('model_info'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (EventsJornal::create($data)){
            return response()->json([
                'fail' => false,
                'text' => 'Evento creado exitosamente..!',
                'redirect_url' => route('events_jornal.index')
            ]);
        } else {
            return response()->json([
                'fail' => true,
    ...
    public function destroy(Request $request)
    {
        ...
        $event = EventsJornal::findOrFail($encrypted_event_id);
    ...
    public function view(Request $request)
    {
        ...
        /*$evento = Event::with(['user' => function ($query) {
