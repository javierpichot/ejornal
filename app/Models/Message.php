...
class Message extends Eloquent
{
     ...
     * @var array
     */
    protected $fillable = ['thread_id', 'user_id', 'body', 'files'];
    ...
    {
        $this->table = ModelsMessage::table('messages');
    ...
    {
        return $this->belongsTo(ModelsMessage::classname(Thread::class), 'thread_id', 'id');
    }
    ...
    {
        return $this->belongsTo(ModelsMessage::user(), 'user_id');
    }
    ...
    {
        return $this->hasMany(ModelsMessage::classname(Participant::class), 'thread_id', 'thread_id');
    }
