...
class Ticket extends Model implements Auditable
{
     ...
     * @var array
     */
    protected $fillable = ['user_id', 'motivo', 'observacion', 'trabajador_id', 'status', 'accion_user_id', 'empresa_id'];

    /**
     * @var array
     */
    protected static $logAttributes = ['user_id', 'motivo', 'observacion', 'trabajador_id', 'status', 'accion_user_id', 'empresa_id'];
