...
class Thread extends Eloquent
{
    ...
    {
        $this->table = ModelsMessage::table('threads');
    ...
    {
        return $this->hasMany(ModelsMessage::classname(Message::class), 'thread_id', 'id');
    }
    ...
    {
        return $this->hasMany(ModelsMessage::classname(Participant::class), 'thread_id', 'id');
    }
    ...
    {
        return $this->belongsToMany(ModelsMessage::classname('User'), Models::table('participants'), 'thread_id', 'user_id');
    }
    ...
    {
        $participantsTable = ModelsMessage::table('participants');
        $threadsTable = ModelsMessage::table('threads');
    ...
    {
        $participantTable = ModelsMessage::table('participants');
        $threadsTable = ModelsMessage::table('threads');
    ...
    public function addParticipant($userId)
    {
        ...
        collect($userIds)->each(function ($userId) {
            ModelsMessage::participant()->firstOrCreate([
                'user_id' => $userId,
                'thread_id' => $this->id,
            ]);
        });
    ...
    public function removeParticipant($userId)
    {
        ...
        ModelsMessage::participant()->where('thread_id', $this->id)->whereIn('user_id', $userIds)->delete();
    }
    ...
    {
        $participantsTable = ModelsMessage::table('participants');
        $usersTable = ModelsMessage::table('users');
        $userPrimaryKey = ModelsMessage::user()->getKeyName();
