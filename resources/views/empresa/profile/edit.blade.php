...
@section('content')
        {{ Form::model($empresa, ['route' => ['empresa.update', $empresa->id], 'role' => 'form', 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'id' => 'form'])
        }}
        ...
        $().ready(function() {
            ...
            $('.tareas').on('beforeItemRemove', function(event) {
               ...
               if (!event.options || !event.options.preventPost) {
                   $.ajax(
                    {
                        url:  "/admin/tarea/<?php echo $empresa->id ?>/destroy",
