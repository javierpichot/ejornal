...
@section('titulo', 'Gestion de incidencias')
...
@section('main-content')
    <nav aria-label="breadcrumb">
    	<ol class="breadcrumb">
    		<li class="breadcrumb-item" aria-current="page"><a href="{{ route('empresa.show', ['id' => $empresa->id, 'name' => $empresa->nombre] )}}">{{ $empresa->nombre }}</a></li>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
                Incidencia {{ $empresa->nombre }} # {{ $incidencia->id }}
            </h3>
          </div>
          <div class="box-body">
              <div class="form-row">
                  <div class="col-md-6 mb-3">
                      ...
                      {!! Form::select('tipo_incidencia_id', $tipo_incidencias->pluck('nombre', 'id'), isset($incidencia) ? $incidencia->tipo_incidencia_id : null, [ 'class' => 'form-control box-size', 'required' => 'required', 'disabled' => true]) !!}
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <div id="fecha_incidencia" class="input-group date">
                          ...
                          {!! Form::text('fecha', isset($incidencia) ? $incidencia->fecha : null, ['class' => 'form-control box-size', 'placeholder' => "Hora y fecha", 'required' => 'required', 'disabled' => true]) !!}
                          @if  ($errors->has('fecha'))
                          <span class="help-block">
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::text('lugar', isset($incidencia) ? $incidencia->lugar : null, ['class' => 'form-control box-size', 'placeholder' => "Sector donde ocurrio", 'required' => 'required', 'disabled' => true]) }}
                      @if  ($errors->has('lugar'))
                      <span class="help-block">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::text('tarea', isset($incidencia) ? $incidencia->tarea : null, ['class' => 'form-control box-size', 'placeholder' => "Tarea desarrollada", 'required' => 'required', 'disabled' => true]) }}
                      @if  ($errors->has('tarea'))
                      <span class="help-block">
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::text('maquinaria_herramientas', isset($incidencia) ? $incidencia->maquinaria_herramientas : null, ['class' => 'form-control box-size', 'placeholder' => "Maquinaria y herramientas utilizadas", 'required' => 'required', 'disabled' => true]) }}
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::text('proteccion', isset($incidencia) ? $incidencia->proteccion : null, ['class' => 'form-control box-size', 'placeholder' => "Metodos de protección utilizados", 'required' => 'required', 'disabled' => true]) }}
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-12 mb-3">
                      ...
                      {{ Form::text('testigos', isset($incidencia) ? $incidencia->testigos : null, ['class' => 'form-control box-size', 'placeholder' => "Testigos que lo presenciaron", 'required' => 'required', 'disabled' => true]) }}
              ...
              <div class="form-row">
                  <div class="col-md-12 mb-3">
                      ...
                      {{ Form::textarea('descripcion', isset($incidencia) ? $incidencia->descripcion : null, ['class' => 'form-control box-size', 'placeholder' => "Descripcion", 'required' => 'required', 'disabled' => true]) }}
              ...
              <div class="form-row">
                  ...
                  <div class="form-group col-md-4 mb-3">
                      ...
                      {!! Form::select('forma_accidente_id', $forma_accidentes->pluck('nombre', 'id'), isset($incidencia) ? $incidencia->forma_accidente_id : null, ['placeholder' => 'Consultas', 'class' => 'form-control box-size', 'disabled' => true]) !!}
                  ...
                  <div class="form-group col-md-4 mb-3">
                      ...
                      {!! Form::select('tipo_lesion_id', $tipo_lesions->pluck('nombre', 'id'), isset($incidencia) ? $incidencia->tipo_lesion_id : null, ['placeholder' => 'Consultas', 'class' => 'form-control box-size', 'disabled' => true]) !!}
                  ...
                  <div class="form-group col-md-4 mb-3">
                      ...
                      {!! Form::select('ubicacion_lesion_id', $ubicacion_lesions->pluck('nombre', 'id'), isset($incidencia) ? $incidencia->ubicacion_lesion_id : null, ['placeholder' => 'Consultas', 'class' => 'form-control box-size', 'disabled' => true]) !!}
              ...
              <div class="form-row">
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::textarea('examen_medico', isset($incidencia) ? $incidencia->examen_medico : null, ['class' => 'form-control box-size', 'placeholder' => "Descripcion", 'required' => 'required', 'disabled' => true]) }}
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::textarea('perimetria_medica', isset($incidencia) ? $incidencia->perimetria_medica : null, ['class' => 'form-control box-size', 'placeholder' => "Descripcion", 'required' => 'required', 'disabled' => true]) }}
              ...
              <div class="form-row">
                  <div class="col-md-12 mb-3">
                      ...
                      {{ Form::textarea('causas', isset($incidencia) ? $incidencia->causas : null, ['class' => 'form-control box-size', 'placeholder' => "Descripcion", 'disabled' => true]) }}
              ...
              <div class="form-row">
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::textarea('acciones_inmediatas', isset($incidencia) ? $incidencia->acciones_inmediatas : null, ['class' => 'form-control box-size', 'placeholder' => "Descripcion", 'disabled' => true]) }}
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::textarea('acciones_correctivas', isset($incidencia) ? $incidencia->acciones_correctivas : null, ['class' => 'form-control box-size', 'placeholder' => "Descripcion", 'disabled' => true]) }}
              ...
              <div class="form-row">
                  <div class="form-group col-md-12">
                      ...
                      {!! Form::select('consulta_id', $consultas->pluck('created_at', 'id'), isset($incidencia) ? $incidencia->consulta_id : null, ['placeholder' => 'Consultas', 'class' => 'form-control box-size', 'disabled' => true]) !!}
              ...
              <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::text('numero_art', isset($incidencia) ? $incidencia->numero_art : null, ['class' => 'form-control box-size', 'placeholder' => "# art", 'disabled' => true]) }}
                  ...
                  <div class="col-md-6 mb-3">
                      ...
                      {{ Form::text('derivacion', isset($incidencia) ? $incidencia->derivacion : null, ['class' => 'form-control box-size', 'placeholder' => "Clinica asociada a ART", 'disabled' => true]) }}
               ...
               $('#fecha_incidencia').datetimepicker({
                  format: 'YYYY-MM-DD HH:mm'              });
                   ...
                   $('#fotos_escenario').fileinput({
                      ...
                      initialPreview: ["{{ asset('storage/empresas/'. $empresa->id  .'/'.  $incidencia->fotos_escenario) }}"],
                      initialPreviewAsData: true,
                      initialPreviewDownloadUrl: "{{ route('empresa.documentacion.generate',['empresa_id' =>  $empresa->id, 'filename' => $incidencia->fotos_escenario, 'type' => ''] ) }}",
                      <?php } ?>
                      maxFileCount: 5,
                      theme: 'fa',
                      language: 'es',
                  ...
                  $('#declaracion_accidente').fileinput({
                      ...
                      previewTemplates: 'file-preview-pdf',
                      initialPreviewFileType: 'pdf',
                      initialPreview: ["{{ asset('storage/empresas/'. $empresa->id  .'/'.  $incidencia->fotos_accidente) }}"],
                      initialPreviewAsData: true,
                      initialPreviewDownloadUrl: "{{ route('empresa.documentacion.generate',['empresa_id' =>  $empresa->id, 'filename' => $incidencia->fotos_accidente, 'type' => ''] ) }}",
                      <?php } ?>
                      maxFileCount: 5,
                      theme: 'fa',
                      language: 'es',
                  ...
                  $('#fotos_lesiones').fileinput({
                      ...
                      previewTemplates: 'file-preview-pdf',
                      initialPreviewFileType: 'pdf',
                      initialPreview: ["{{ asset('storage/empresas/'. $empresa->id .'/'.  $incidencia->fotos_lesion) }}"],
                      initialPreviewAsData: true,
                      initialPreviewDownloadUrl: "{{ route('empresa.documentacion.generate',['empresa_id' =>  $empresa->id, 'filename' => $incidencia->fotos_lesion, 'type' => ''] ) }}",
                      <?php } ?>
                      maxFileCount: 5,
                      theme: 'fa',
                      language: 'es',
