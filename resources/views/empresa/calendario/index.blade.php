    ...
    <!-- Main content -->
              ...
              <div class="box-header with-border">
                  ...
                  <div class="pull-right">
                      <a href="#" class="btn btn-default" title="Add event" data-post-client_id="{{ $empresa->id }}" data-act="ajax-modal" data-title="Agregar evento" data-action-url="{{ route('events.modal_form') }}"><i class="fa fa-plus-circle"></i> Añadir evento</a>
                      <a href="#" class="hide" id="add_event_hidden" title="Añadir evento" data-post-client_id="{{ $empresa->id }}" data-act="ajax-modal" data-title="Agregar evento" data-action-url="{{ route('events.modal_form') }}"></a>
                      <a href="#" class="hide" id="show_event_hidden" data-post-client_id="" data-post-cycle="0" data-post-editable="1" title="Detalles de evento" data-act="ajax-modal" data-title="Detalles de evento" data-action-url="{{ route('events.view') }}" data-post-id=""></a>
                      <a href="#" class="hide" data-post-id="" id="show_leave_hidden" data-act="ajax-modal" data-title="Detalles de evento" data-action-url="{{ route('application_details.show') }}"></a>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#event-calendar").fullCalendar({
                ...
                events: "/events/calendar_events/{{ $empresa->id }}/",
