    ...
    <!-- Main content -->
              ...
              <div class="box-header with-border">
                  ...
                  <div class="pull-right">
                      <a href="#" class="btn btn-default" title="Add event" data-post-client_id="" data-act="ajax-modal" data-title="Agregar evento" data-action-url="{{ route('events_jornal.modal_form') }}"><i class="fa fa-plus-circle"></i> Añadir evento</a>
                      <a href="#" class="hide" id="add_event_hidden" title="Añadir evento" data-post-client_id="" data-act="ajax-modal" data-title="Agregar evento" data-action-url="{{ route('events_jornal.modal_form') }}"></a>
                      <a href="#" class="hide" id="show_event_hidden" data-post-client_id="" data-post-cycle="0" data-post-editable="1" title="Detalles de evento" data-act="ajax-modal" data-title="Detalles de evento" data-action-url="{{ route('events_jornal.view') }}" data-post-id=""></a>
                      <a href="#" class="hide" data-post-id="" id="show_leave_hidden" data-act="ajax-modal" data-title="Detalles de evento" data-action-url="{{ route('events_jornal.show') }}"></a>
