...
@section('main-content')
    ...
    <div class="box box-info">
         <div class="box-header">
           ...
           <a href="{{ route('empresa.usuario.create') }}" class="btn btn-primary pull-right">
     ...
     <td>Email</td>
                 ...
                 <tbody>
                     <?php $i=1; ?>
                     @foreach($user_empresas->users AS $s)
                         @php
...
<td>{{ $s->nombre }} {{ $s->apellido }}</td>
 ...
 <td>{{ $s->email }}</td>
                             ...
                             <td>
                                 <a class="btn btn-primary" href="{{ route('empresa.usuario.edit', ['id' => $s->id, 'empresa_id' => $user_empresas->id]) }}">
                                    <i class="fa fa-pencil"></i>
                                 </a>
                                  <a class="btn btn-primary" title="Edit" href="{{route('empresa.usuario.show', ['id' => $s->id, 'empresa_id' => $user_empresas->id])}}"><i title="Editar incidencia" class="fa fa-eye"></i></a>
