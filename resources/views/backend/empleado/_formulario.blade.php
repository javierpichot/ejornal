...
@section('content')
	...
	<form action="{{ $empleado ? route('empleado.update', ['empleado' => $empleado->id]) : route('empleado.store') }}" method="post" id="form">
            ...
            <div class="card-body">
            	<div class="row">
                    <div class="col-md-6 col-sm-12 {{ $errors->has('empleado_code') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <input name="empleado_code" class="form-control" type="text" placeholder="Codigo del Empleado" value="{{ $empleado->exists ? $empleado->empleado_code : $codigo }}" readonly="true" required="true"/>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 {{ $errors->has('empleado_document') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <input name="empleado_document" class="form-control" type="text" placeholder="C&eacute;dula del Empleado" value="{{ $empleado->exists ? $empleado->empleado_document : '' }}" required="true"/>
                    ...
                    <div class="col-md-6 col-sm-12 {{ $errors->has('empleado_firstdate') ? ' has-error' : '' }}">
                            <div class="form-group" id="date_1">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input class="form-control" name="empleado_firstdate" type="text" placeholder="Fecha de Nacimiento del Empleado"  value="{{ $empleado->exists ? $empleado->empleado_firstdate : '' }}" data-date-format="yyyy-mm-dd" readonly="true" required="true"/>
                                    </div>     
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 {{ $errors->has('empleado_firstname') ? ' has-error' : '' }}">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input name="empleado_firstname" class="form-control" type="text" placeholder="Nombre del Empleado" value="{{ $empleado->exists ? $empleado->empleado_firstname : '' }}" required="true"/>
                    ...
                    <div class="col-md-6  col-sm-12  {{ $errors->has('empleado_lastname') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <input name="empleado_lastname" class="form-control" type="text" placeholder="Apellido del Empleado" value="{{ $empleado->exists ? $empleado->empleado_lastname : '' }}" required="true"/>
                 ...
                 <div class="row">
                    <div class="col-md-12 col-sm-12 {{ $errors->has('sucursal_id') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <select id="sucursal_id" name="sucursal_id" class="form-control" required="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6  col-sm-12 {{ $errors->has('cargo_id') ? ' has-error' : '' }}">
                        <div class="form-group">
                            <label>Cargo</label>
                            <select id="cargo_id" name="cargo_id" class="form-control" required="true">
                          		<option value="">Seleccione ...</option>
                          		@if($car_det)
            ...
            <div class="card-body">
            	<div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        <textarea class="form-control" id="empleado_observacion" name="empleado_observacion" rows="5" placeholder="Observaciones del Empleado">{{ $empleado->exists ? $empleado->empleado_observacion : '' }}</textarea>
                    </div>
                 </div>
            </div>
        </div>
