...
<script src="{{ asset('bower_components/bootstrap-tagsinput/bootstrap-tagsinput.js') }}" ></script>
<script src="https://cdn.datatables.net/fixedcolumns/3.2.2/js/dataTables.fixedColumns.min.js
"></script>
<script src="https://cdn.datatables.net/buttons/1.5.2/js/dataTables.buttons.min.js" ></script>
...
<!--FileInput-->
<script src="{{ asset('bower_components/fileinput/fileinput.min.js') }}" ></script>
<script src="{{ asset('bower_components/fileinput/locales/fr.js') }}" ></script>
<script src="{{ asset('bower_components/fileinput/locales/es.js') }}" ></script>
