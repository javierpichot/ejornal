			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div align="middle" >
		            ...
		            <div class="alert alert-warning" align="justify" style=" font-size:20px;">
		                   <div align="middle">   <h4><i class="icon fa fa-warning"></i>¡Atención!</h4></div> <br>Recibe nuestra bienvenida {{ $user->nombre }}<br><br>
		   ...
		   <div id="ocultar_legales" name="ocultar_legales" align="middle">
		              ...
		              <div class="row">
		                ...
		                @foreach ($empresas as $key => $empresa)
		                    <div class="col-sm-4">
		                      <div class="card">
		        <a href="{{ route('empresa.show', ['id' => $empresa->id, 'name' => $empresa->nombre] )}}">                   <img data-src="{{ asset('img/avatar5.png')}}" class="card-img-top img" src="{{ asset('storage/empresas/'. $empresa->id . '/perfil/'. $empresa->logo) }}" alt="{{ $empresa->nombre }}">
