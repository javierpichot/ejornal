@isset($presupuesto)
    ...
    {{ Form::model($presupuesto, ['route' => ['trabajador.presupuesto.pedido.update',$presupuesto->id , $empresa->id], 'role' => 'form', 'method' => 'PATCH', 'id' => 'frm'])
    }}
@endisset

@empty ($presupuesto)
    {{ Form::open(['route' => 'trabajador.presupuesto.pedido.store', 'role' => 'form', 'method' => 'post', 'id' => 'frm']) }}
@endempty
