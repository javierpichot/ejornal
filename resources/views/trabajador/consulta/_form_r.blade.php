...
<div class="modal-body">
    ...
    <div id="capa_medica" style="display: {{ isset($consulta) ? ($consulta->consulta_tipo_id == 1) ? 'block' : 'none' : 'none' }}" >
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                {{ Form::label('consulta_motivo_id', "Diagnóstico*") }}
                {!! Form::select('consulta_motivo_id', $consulta_motivo->pluck('nombre', 'id'), isset($consulta) ? $consulta->consulta_motivo_id : null, ['placeholder' => 'Diagnóstico', 'class' => 'form-control box-size']) !!}
                @if ($errors->has('consulta_motivo_id'))
                    <span class="help-block">
                    <strong>{{ $errors->first('consulta_motivo_id') }}</strong>
                </span>
        ...
        <div class="row clonedata" id="clonedata">
            <div class="col-xs-6">
                ...
                {!! Form::select('prestaciton_farmacia_droga_id[]', $prestacion_farmacia_droga->pluck('nombre', 'id'), null, ['placeholder' => 'Medicacion', 'class' => 'form-control box-size mb-3']) !!}
