        ...
        <div slot="body" class="modal-body">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <multiselect v-model="form.consulta_tipo_id" track-by="id" label="nombre" placeholder="Tipo consulta" :options="consulta_tipos" :searchable="true" :allow-empty="false" :multiple="false"></multiselect>
            ...
            <div class="row" v-for="(prestacion_farmaco, index) in prestacion_farmacos">
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                      <multiselect v-model="prestacion_farmaco.prestacion_farmacia_droga_id" track-by="id" label="nombre" placeholder="Medicacion" :options="prestacion_farmacias" :searchable="true" :allow-empty="false" :multiple="false"></multiselect>
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group">
                        <input type="text" v-model="prestacion_farmaco.cantidad" class="form-control input-lg">
            ...
            <template v-if="form.consulta_tipo_id.id == 1">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <multiselect v-model="form.consulta_motivo_id" track-by="id" label="nombre" placeholder="Especialidad" :options="consulta_motivos" :searchable="true" :allow-empty="false" :multiple="false" @select="fetchDiagnostico"></multiselect>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea v-model="form.plan" cols="30" rows="4" class="form-control" :class="{ 'is-invalid': errors.plan }"></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea v-model="form.diagnostico" cols="30" rows="4" class="form-control" :class="{ 'is-invalid': errors.diagnostico }"></textarea>
