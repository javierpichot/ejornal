@if(isset($ticket))
    {{ Form::model($ticket, ['route' => ['ticket-jornals.update', $ticket->id], 'role' => 'form', 'method' => 'PATCH', 'id' => 'ticket'])
    }}
    <input type="hidden" name="user_id" value="{{ $ticket->user_id }}">
@else
    {!! Form::open(['route' => 'ticket-jornals.store', 'id'=>'ticket']) !!}
...
<div class="modal-header">
    ...
    <h4 class="modal-title">{{isset($ticket)?'Editar':'Crear nuevo'}} ticket jornals</h4>
