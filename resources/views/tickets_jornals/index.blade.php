    ...
    <div class="modal fade" id="newticket" tabindex="-1" role="dialog" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                @include('tickets_jornals.includes.form')
            </div>
        </div>
    </div>
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.dashboard.index') }}">Equipo de Jornal</a></li>
                        ...
                        @foreach($tickets AS $c)
                            ...
                            <tr id="ticket_{{ $c->id }}">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-warning" title="Edit" href="#modalForm" data-toggle="modal" data-href="{{route('ticket-jornals.edit', ['id' => $c->id])}}"><i title="Editar ticket" class="fa fa-pencil"></i></a>

                                    <a href="{{ route('ticket-jornals.comentarios.view', ['id' => $c->id]) }}" target="_blank"><button class="btn btn-success"><i title="Ver comentarios" class="fa fa-commenting-o"></i></button></a>

                                    @csrf
                                    <button type="submit" class="btn btn-danger delete-confirm" data-id="{{ $c->id }}" data-href="{{ route('ticket-jornals.destroy', ['id' => $c->id]) }}">
