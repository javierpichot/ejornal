    <modal ref="actionCreate" size="medium" :opened="getAllRoles">
        <form slot="form" action="" method="post" @submit.prevent="storeTicket">
            ...
            <div slot="body" class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <multiselect v-model="form.roles" track-by="name" label="name" placeholder="Seleccione un rol" :options="roles" :searchable="true" :allow-empty="false" :multiple="true"></multiselect>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                      <div class="form-group">
                        <label>Motivo</label>
                        <input type="text" v-model="form.motivo" class="form-control" :class="{ 'is-invalid': errors.motivo }" required>
